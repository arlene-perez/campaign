  ...
  return (
    <div className={styles.pageOuter}>
      ...
      <h3>***Although most hurricanes occur in late August or early September, we are asking 
        ...
        <h3>We are currently waiting on our requests for group rates for flights from Delta, American Airlines, and Southwest leaving from LAX. We will update you as soon as we know more details.</h3>
