    ...
    <div className={styles.pageOuter}>
      <div className={styles.registryPage}>
        ...
        <div className={styles.registryInnerContainerText}>
          ...
          Your presence is enough of a present to us! But for those of you who would like to get a gift, we've put together a wish-list to help you out below by using the link. We are planning on taking our honeymoon to Europe after the wedding and can't wait to celebrate! If you would prefer to give cash, feel free to use Venmo! We also love any e-gift cards if you'd like to purchase one. Thank you again!
          <br></br>
          <br></br>
          Love, 
          <br></br>
